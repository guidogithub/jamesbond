...
int Java_com_bond_controloverlay_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_com_bond_controloverlay_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
